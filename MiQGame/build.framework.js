var UnityModule = function(Module) {
  ...
  function matchToOldDevice(newDevice) {
    ...
    console.log("lllllllllllllllll len 1")
  ...
  if (ENVIRONMENT_IS_NODE) {
    ...
    console.log("lllllllllllllllll len 2")
  ...
  function ccall(ident, returnType, argTypes, args, opts) {
    console.log("lllllllllllllllll len 3")
    var toC = {
      string: function (str) {
        var ret = 0;
    ...
    var stack = 0;
    if (args) {
      console.log("lllllllllllllllll len 4")
  ...
  function stringToUTF8Array(str, heap, outIdx, maxBytesToWrite) {
    ...
    console.log("lllllllllllllllll len 5")
  ...
  function lengthBytesUTF8(str) {
    ...
    var len = 0;
    console.log("lllllllllllllllll len 6")
    for (var i = 0; i < str.length; ++i) {
      var u = str.charCodeAt(i);
      if (u >= 55296 && u <= 57343)
  ...
  function writeAsciiToMemory(str, buffer, dontAddNull) {
    console.log("lllllllllllllllll len 7")
    for (var i = 0; i < str.length; ++i) {
  ...
  function preRun() {
    if (Module["preRun"]) {
      if (typeof Module["preRun"] == "function")
        ...
        console.log("lllllllllllllllll len 8")
  ...
  function postRun() {
    if (Module["postRun"]) {
      if (typeof Module["postRun"] == "function")
        ...
        console.log("lllllllllllllllll len 9")
  ...
  var wasmBinaryFile = "Build/build.wasm";
  ...
  function getBinary(file) {
    try {
      if (file == wasmBinaryFile && wasmBinary) {
        console.log("+++++++++++++ getBinary 1", wasmBinary.byteLength)
  ...
  function createWasm() {
    ...
    function receiveInstance(instance, module) {
      console.log("+++++++++++++ createWasm 1", instance.exports)
    ...
    function instantiateArrayBuffer(receiver) {
      return getBinaryPromise()
        .then(function (binary) {
          console.log("+++++++++++++ createWasm 2", binary)
  ...
  function callRuntimeCallbacks(callbacks) {
    console.log("lllllllllllllllll len 10")
  ...
  function dynCallLegacy(sig, ptr, args) {
    ...
    console.log("lllllllllllllllll len 11")
  ...
  function jsAudioCreateUncompressedSoundClip(buffer, error) {
    ...
    soundClip.getLength = function () {
      ...
      console.log("lllllllllllllllll len 12")
    ...
    soundClip.getData = function (ptr, length) {
      ...
      console.log("lllllllllllllllll len 13")
    ...
    try {
      ...
      var _userEventCallback = function () {
        try {
          ...
          console.log("lllllllllllllllll len 14")
  ...
  function jsAudioCreateCompressedSoundClip(audioData) {
    ...
    soundClip.createSourceNode = function () {
      var self = this;
      console.log("lllllllllllllllll len 15")
  ...
  function jsAudioCreateUncompressedSoundClipFromPCM(
    ...
    console.log("lllllllllllllllll len 16")
  ...
  function _JS_SystemInfo_GetMemory() {
    console.log("lllllllllllllllll len 17")
  ...
  var mAdMap = {};
  function _QGAccessFile(uri) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
    var uriStr = Pointer_stringify(uri);
    var result = qg.accessFile({ uri: uriStr });
    var bufferSize = lengthBytesUTF8(result) + 1;
    var buffer = _malloc(bufferSize);
    stringToUTF8(result, buffer, bufferSize);
    return buffer;
  }
  function _QGCreateBannerAd(adId, posId, style, adIntervals) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
    ...
    if (bannerAd) {
      ...
      bannerAd.onLoad(function () {
        var json = JSON.stringify({ callbackId: adIdStr });
  ...
  function _QGCreateBoxBannerAd(adId, posId) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
    ...
    var posIdStr = Pointer_stringify(posId);
    var adIdStr = Pointer_stringify(adId);
    var boxBannerAd = qg.createBoxBannerAd({ posId: posIdStr });
    if (boxBannerAd) {
  ...
  function _QGCreateBoxPortalAd(adId, posId, image, marginTop) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
  ...
  function _QGCreateCustomAd(adId, posId, style) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
  ...
  function _QGCreateInterstitialAd(adId, posId) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
    ...
    var posIdStr = Pointer_stringify(posId);
    var adIdStr = Pointer_stringify(adId);
    var interstitialAd = qg.createInterstitialAd({ posId: posIdStr });
    if (interstitialAd) {
  ...
  function _QGCreateNativeAd(adId, posId) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
    ...
    var posIdStr = Pointer_stringify(posId);
    var adIdStr = Pointer_stringify(adId);
    var nativeAd = qg.createNativeAd({ posId: posIdStr });
    if (nativeAd) {
      mAdMap.set(adIdStr, nativeAd);
      nativeAd.onLoad(function (rec) {
        var json = JSON.stringify({ callbackId: adIdStr, adList: rec.adList });
        unityInstance.SendMessage(
          CONSTANT.ACTION_CALL_BACK_CLASS_NAME_DEFAULT,
          CONSTANT.ACTION_CALL_BACK_METHORD_NAME_AD_LOAD_NATIVE,
          json
        );
      });
  ...
  function _QGCreateRewardedVideoAd(adId, posId) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
    ...
    var posIdStr = Pointer_stringify(posId);
    var adIdStr = Pointer_stringify(adId);
    var rewardedVideoAd = qg.createRewardedVideoAd({ posId: posIdStr });
    if (rewardedVideoAd) {
  ...
  function _QGGetFileBuffer(buffer, callBackId) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
  ...
  function _QGGetUserInfo(success, fail) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
    ...
    qg.getUserInfo({
      success: function (res) {
        var json = JSON.stringify({ callbackId: successID, data: res.data });
        unityInstance.SendMessage(
          CONSTANT.ACTION_CALL_BACK_CLASS_NAME_DEFAULT,
  ...
  function _QGHasShortcutInstalled(success, fail) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
  ...
  function _QGHideAd(adId, success, fail) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
    ...
    if (ad) {
      ad.hide()
        .then(function () {
          var json = JSON.stringify({ callbackId: successID });
          unityInstance.SendMessage(
            CONSTANT.ACTION_CALL_BACK_CLASS_NAME_DEFAULT,
  ...
  function _QGInstallShortcut(message, success, fail) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
    ...
    qg.installShortcut({
      message: messageStr,
      success: function (res) {
        var json = JSON.stringify({ callbackId: successID, data: res });
        unityInstance.SendMessage(
          CONSTANT.ACTION_CALL_BACK_CLASS_NAME_DEFAULT,
          CONSTANT.ACTION_CALL_BACK_METHORD_NAME_DEFAULT,
          json
      ...
      fail: function (res) {
        var json = JSON.stringify({ callbackId: failID, errMsg: res });
        unityInstance.SendMessage(
          CONSTANT.ACTION_CALL_BACK_CLASS_NAME_DEFAULT,
          CONSTANT.ACTION_CALL_BACK_METHORD_NAME_DEFAULT,
          json
  ...
  function _QGLoadAd(adId, success, fail) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
  ...
  function _QGLogin(success, fail) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
  ...
  function _QGPay(param, success, fail, cancel, complete) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
    ...
    qg.pay({
      ...
      success: function (ret) {
        var json = JSON.stringify({ callbackId: successID, data: ret.data });
        unityInstance.SendMessage(
          CONSTANT.ACTION_CALL_BACK_CLASS_NAME_DEFAULT,
          "PayResponseCallback",
          json
      ...
      fail: function (err) {
        var json = JSON.stringify({ callbackId: failID, data: ret.data });
        unityInstance.SendMessage(
          CONSTANT.ACTION_CALL_BACK_CLASS_NAME_DEFAULT,
          "PayResponseCallback",
          json
      ...
      cancel: function (ret) {
        var json = JSON.stringify({ callbackId: cancelID, data: ret.data });
        unityInstance.SendMessage(
          CONSTANT.ACTION_CALL_BACK_CLASS_NAME_DEFAULT,
          "PayResponseCallback",
          json
      ...
      complete: function () {
        var json = JSON.stringify({ callbackId: completeID });
        unityInstance.SendMessage(
          CONSTANT.ACTION_CALL_BACK_CLASS_NAME_DEFAULT,
          "PayResponseCallback",
          json
  ...
  function _QGReadFile(uri, encoding, position, length, success, fail) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
    ...
    qg.readFile({
      ...
      fail: function (data, code) {
        var json = JSON.stringify({ callbackId: failID, errCode: code });
        unityInstance.SendMessage(
          CONSTANT.ACTION_CALL_BACK_CLASS_NAME_DEFAULT,
          "ReadFileResponseCallback",
          json
  ...
  function _QGReportAdClick(adId, posId) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
    ...
    var ad = mAdMap.get(adIdStr);
    if (ad) {
      ad.reportAdClick({ adId: posIdStr });
    }
  }
  function _QGReportAdShow(adId, posId) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
    ...
    var ad = mAdMap.get(adIdStr);
    if (ad) {
      ad.reportAdShow({ adId: posIdStr });
    }
  }
  function _QGShowAd(adId, success, fail) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
  ...
  function _QGStorageDeleteAllSync() {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
  ...
  function _QGStorageDeleteKeySync(key) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
    var keyStr = Pointer_stringify(key);
    qg.deleteStorageSync({ key: keyStr });
  }
  function _QGStorageGetFloatSync(key, defaultValue) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
    ...
    var result = qg.getStorageSync({ key: keyStr, default: defaultValueStr });
    return parseFloat(result);
  }
  function _QGStorageGetIntSync(key, defaultValue) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
  ...
  function _QGStorageGetStringSync(key, defaultValue) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
  ...
  function _QGStorageHasKeySync(key) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
    var keyStr = Pointer_stringify(key);
    var result = qg.getStorageSync({ key: keyStr });
    return result === "" ? false : true;
  }
  function _QGStorageSetFloatSync(key, value) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
    var keyStr = Pointer_stringify(key);
    var valueStr = value + "";
    qg.setStorageSync({ key: keyStr, value: valueStr });
  }
  function _QGStorageSetIntSync(key, value) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
  ...
  function _QGStorageSetStringSync(key, value) {
    if (typeof qg == "undefined") {
      console.log("qg.minigame.jslib  qg is undefined");
      return;
    }
  ...
  function _QGWriteFile(
    ...
    var textFinal =
      encodingStr == "utf8"
        ? textStrFinal
        : HEAPU8.slice(textData, length + textData).buffer;
    qg.writeFile({
      uri: uriStr,
      encoding: encodingStr,
      position: position,
  ...
  function ___cxa_find_matching_catch_2() {
    ...
    console.log("lllllllllllllllll len 18")
  ...
  function ___cxa_find_matching_catch_4() {
    ...
    var exceptionThrowBuf = stackAlloc(4);
    HEAP32[exceptionThrowBuf >> 2] = thrown;
    console.log("lllllllllllllllll len 19")
    for (var i = 0; i < typeArray.length; i++) {
      var caughtType = typeArray[i];
      if (caughtType === 0 || caughtType === thrownType) {
        break;
  ...
  var PATH = {
    ...
    normalizeArray: function (parts, allowAboveRoot) {
      console.log("lllllllllllllllll len 20")
      var up = 0;
    ...
    dirname: function (path) {
      console.log("lllllllllllllllll len 21")
  ...
  var PATH_FS = {
    resolve: function () {
      var resolvedPath = "",
        ...
        console.log("lllllllllllllllll len 22")
    ...
    relative: function (from, to) {
      ...
      function trim(arr) {
        var start = 0;
        console.log("lllllllllllllllll len 23")
  ...
  var TTY = {
    ...
    default_tty_ops: {
      get_char: function (tty) {
        console.log("lllllllllllllllll len 24")
        if (!tty.input.length) {
          var result = null;
          if (ENVIRONMENT_IS_NODE) {
            var BUFSIZE = 256;
      ...
      flush: function (tty) {
        console.log("lllllllllllllllll len 25")
    ...
    default_tty1_ops: {
      ...
      flush: function (tty) {
        console.log("lllllllllllllllll len 26")
        if (tty.output && tty.output.length > 0) {
          err(UTF8ArrayToString(tty.output, 0));
          tty.output = [];
        }
  ...
  var MEMFS = {
    ...
    expandFileStorage: function (node, newCapacity) {
      console.log("lllllllllllllllll len 27")
    ...
    node_ops: {
      getattr: function (node) {
        ...
        if (FS.isDir(node.mode)) {
          ...
          console.log("lllllllllllllllll len 28")
    ...
    stream_ops: {
      ...
      mmap: function (stream, address, length, position, prot, flags) {
        ...
        if (!(flags & 2) && contents.buffer === buffer) {
          ...
          console.log("lllllllllllllllll len 29")
  ...
  var IDBFS = {
    ...
    getLocalSet: function (mount, callback) {
      ...
      console.log("lllllllllllllllll len 30")
      while (check.length) {
        var path = check.pop();
        var stat;
        try {
  ...
  var FS = {
    ...
    lookupPath: function (path, opts) {
      ...
      var current = FS.root;
      var current_path = "/";
      console.log("lllllllllllllllll len 31")
    ...
    getPath: function (node) {
      ...
      while (true) {
        if (FS.isRoot(node)) {
          ...
          console.log("lllllllllllllllll len 32")
    ...
    hashName: function (parentid, name) {
      var hash = 0;
      console.log("lllllllllllllllll len 33")
    ...
    getMounts: function (mount) {
      var mounts = [];
      var check = [mount];
      console.log("lllllllllllllllll len 34")
      while (check.length) {
        var m = check.pop();
        mounts.push(m);
    ...
    syncfs: function (populate, callback) {
      ...
      function done(errCode) {
        ...
        console.log("lllllllllllllllll len 35")
    ...
    mkdirTree: function (path, mode) {
      var dirs = path.split("/");
      var d = "";
      console.log("lllllllllllllllll len 36")
    ...
    writeFile: function (path, data, opts) {
      ...
      if (typeof data === "string") {
        ...
        console.log("lllllllllllllllll len 37")
    ...
    quit: function () {
      ...
      if (fflush) fflush(0);
      console.log("lllllllllllllllll len 38")
    ...
    createPath: function (parent, path, canRead, canWrite) {
      ...
      console.log("lllllllllllllllll len 39")
      while (parts.length) {
        var part = parts.pop();
        if (!part) continue;
    ...
    createDataFile: function (parent, name, data, canRead, canWrite, canOwn) {
      ...
      if (data) {
        if (typeof data === "string") {
          console.log("lllllllllllllllll len 40")
    ...
    createDevice: function (parent, name, input, output) {
      ...
      FS.registerDevice(dev, {
        ...
        close: function (stream) {
          console.log("lllllllllllllllll len 41")
    ...
    forceLoadFile: function (obj) {
      ...
      if (typeof XMLHttpRequest !== "undefined") {
        ...
        try {
          ...
          console.log("lllllllllllllllll len 42")
    ...
    createLazyFile: function (parent, name, url, canRead, canWrite) {
      ...
      LazyUint8Array.prototype.get = function LazyUint8Array_get(idx) {
        console.log("lllllllllllllllll len 43")
      ...
      LazyUint8Array.prototype.cacheLength =
        function LazyUint8Array_cacheLength() {
          ...
          if (usesGzip || !datalength) {
            ...
            console.log("lllllllllllllllll len 44")
      ...
      Object.defineProperties(node, {
        usedBytes: {
          get: function () {
            console.log("lllllllllllllllll len 45")
      ...
      stream_ops.read = function stream_ops_read(
        ...
        FS.forceLoadFile(node);
        var contents = stream.node.contents;
        console.log("lllllllllllllllll len 46")
    ...
    saveFilesToDB: function (paths, onload, onerror) {
      ...
      openRequest.onsuccess = function openRequest_onsuccess() {
        ...
        console.log("lllllllllllllllll len 47")
        var ok = 0,
          fail = 0,
          total = paths.length;
        function finish() {
    ...
    loadFilesFromDB: function (paths, onload, onerror) {
      ...
      openRequest.onsuccess = function openRequest_onsuccess() {
        ...
        console.log("lllllllllllllllll len 48")
        var files = transaction.objectStore(FS.DB_STORE_NAME);
        var ok = 0,
          fail = 0,
          total = paths.length;
  ...
  var SYSCALLS = {
    ...
    calculateAt: function (dirfd, path, allowEmpty) {
      ...
      console.log("lllllllllllllllll len 49")
      if (path.length == 0) {
        if (!allowEmpty) {
          throw new FS.ErrnoError(44);
        }
    ...
    doMkdir: function (path, mode) {
      path = PATH.normalize(path);
      console.log("lllllllllllllllll len 50")
  ...
  var SOCKFS = {
    ...
    stream_ops: {
      ...
      read: function (stream, buffer, offset, length, position) {
        ...
        console.log("lllllllllllllllll len 51")
    ...
    websocket_sock_ops: {
      ...
      handlePeerEvents: function (sock, peer) {
        ...
        function handleMessage(data) {
          ...
          var wasfirst = first;
          first = false;
          console.log("lllllllllllllllll len 52")
          if (
            wasfirst &&
            data.length === 10 &&
            data[0] === 255 &&
      ...
      poll: function (sock) {
        console.log("lllllllllllllllll len 53")
      ...
      ioctl: function (sock, request, arg) {
        switch (request) {
          case 21531:
            var bytes = 0;
            console.log("lllllllllllllllll len 54")
      ...
      close: function (sock) {
        ...
        console.log("lllllllllllllllll len 55")
      ...
      recvmsg: function (sock, length) {
        ...
        console.log("lllllllllllllllll len 56")
  ...
  function ___sys_getdents64(fd, dirp, count) {
    try {
      ...
      console.log("lllllllllllllllll len 57")
  ...
  function inetPton6(str) {
    ...
    console.log("lllllllllllllllll len 58")
    if (str.indexOf(".") > 0) {
  ...
  function readAsmConstArgs(sigPtr, buf) {
    console.log("lllllllllllllllll len 59")
  ...
  function setMainLoop(
    ...
    Browser.mainLoop.runner = function Browser_mainLoop_runner() {
      if (ABORT) return;
      console.log("lllllllllllllllll len 60")
      ...
      imagePlugin["handle"] = function imagePlugin_handle(
        ...
        if (Browser.hasBlobConstructor) {
          try {
            ...
            console.log("lllllllllllllllll len 61")
        ...
        if (Browser.hasBlobConstructor) {
          ...
          audio.onerror = function audio_onerror(event) {
            ...
            function encode64(data) {
              ...
              var leftchar = 0;
              var leftbits = 0;
              console.log("lllllllllllllllll len 62")
  ...
  var JSEvents = {
    ...
    removeAllEventListeners: function () {
      console.log("lllllllllllllllll len 63")
    ...
    deferCall: function (targetFunction, precedence, argsList) {
      function arraysHaveEqualContent(arrA, arrB) {
        console.log("lllllllllllllllll len 64")
    ...
    removeDeferredCalls: function (targetFunction) {
      console.log("lllllllllllllllll len 65")
    ...
    runDeferredCalls: function () {
      ...
      console.log("lllllllllllllllll len 66")
      for (var i = 0; i < JSEvents.deferredCalls.length; ++i) {
        var call = JSEvents.deferredCalls[i];
        JSEvents.deferredCalls.splice(i, 1);
        --i;
    ...
    removeAllHandlersOnTarget: function (target, eventTypeString) {
      console.log("lllllllllllllllll len 67")
    ...
    registerOrRemoveHandler: function (eventHandler) {
      ...
      if (eventHandler.callbackfunc) {
        ...
        console.log("lllllllllllllllll len 68")
        for (var i = 0; i < JSEvents.eventHandlers.length; ++i) {
          if (
  ...
  function getCanvasElementSize(target) {
    ...
    var w = stackAlloc(8);
    var h = w + 4;
    console.log("lllllllllllllllll len 69")
  ...
  function setCanvasElementSize(target, width, height) {
    if (!target.controlTransferredOffscreen) {
      ...
      var stackTop = stackSave();
      console.log("lllllllllllllllll len 70")
      var targetInt = stackAlloc(target.id.length + 1);
      stringToUTF8(target.id, targetInt, target.id.length + 1);
  ...
  function fillGamepadEventData(eventStruct, e) {
    ...
    console.log("lllllllllllllllll len 71")
  ...
  function _emscripten_get_num_gamepads() {
    console.log("lllllllllllllllll len 72")
      ...
      if (curr == 37) {
        ...
        switch (String.fromCharCode(next)) {
          ...
          case "p": {
            ...
            console.log("lllllllllllllllll len 73")
  ...
  function _emscripten_get_callstack_js(flags) {
    ...
    console.log("lllllllllllllllll len 74")
    for (var l in lines) {
      var line = lines[l];
      var symbolName = "";
      var file = "";
  ...
  function _emscripten_log_js(flags, str) {
    if (flags & 24) {
      console.log("lllllllllllllllll len 75")
      str = str.replace(/\s+$/, "");
  ...
  function _emscripten_resize_heap(requestedSize) {
    console.log("lllllllllllllllll len 76")
  ...
  function registerTouchEventCallback(
    ...
    console.log("lllllllllllllllll len 77")
  ...
  var GL = {
    ...
    generateTempBuffers: function (quads, context) {
      console.log("lllllllllllllllll len 78")
  ...
  function _environ_get(__environ, environ_buf) {
    console.log("lllllllllllllllll len 79")
    try {
      var bufSize = 0;
  ...
  function _environ_sizes_get(penviron_count, penviron_buf_size) {
    console.log("lllllllllllllllll len 80")
    try {
  ...
  function getHostByName(name) {
    console.log("lllllllllllllllll len 81")
    var ret = _malloc(20);
  ...
  function _glFlushMappedBufferRange(target, offset, length) {
    console.log("lllllllllllllllll len 82")
  ...
  function _glGetActiveUniformBlockiv(
    ...
    console.log("lllllllllllllllll len 83")
    if (!params) {
      GL.recordError(1281);
      return;
    }
  ...
  function _glGetActiveUniformsiv(
    ...
    console.log("lllllllllllllllll len 84")
    if (!params) {
      GL.recordError(1281);
      return;
    }
  ...
  function emscriptenWebGLGet(name_, p, type) {
    console.log("lllllllllllllllll len 85")
    if (!p) {
      GL.recordError(1281);
      return;
    }
  ...
  function _glGetInternalformativ(
    ...
    console.log("lllllllllllllllll len 86")
    if (bufSize < 0) {
      GL.recordError(1281);
      return;
    }
  ...
  function _glGetProgramiv(program, pname, p) {
    console.log("lllllllllllllllll len 87")
    if (!p) {
      GL.recordError(1281);
      return;
    }
  ...
  function _glGetString(name_) {
    console.log("lllllllllllllllll len 88")
  ...
  function _glGetStringi(name, index) {
    ...
    console.log("lllllllllllllllll len 89")
  ...
  function _glGetUniformIndices(
    ...
    console.log("lllllllllllllllll len 90")
    if (!uniformIndices) {
      GL.recordError(1281);
      return;
    }
  ...
  function emscriptenWebGLGetUniform(program, location, params, type) {
    ...
    console.log("lllllllllllllllll len 91")
    program = GL.programs[program];
  ...
  function emscriptenWebGLGetVertexAttrib(index, pname, params, type) {
    ...
    console.log("lllllllllllllllll len 92")
  ...
  function find_closing_parens_index(arr, i, opening = "(", closing = ")") {
    console.log("lllllllllllllllll len 93")
  ...
  function preprocess_c_code(code) {
    console.log("lllllllllllllllll len 94")
    var i = 0,
      len = code.length,
      out = "",
      stack = [1],
    ...
    function tokenize(exprString, keepWhitespace) {
      console.log("lllllllllllllllll len 95")
      var out = [],
    ...
    function expandMacros(str, lineStart, lineEnd) {
      console.log("lllllllllllllllll len 96")
    ...
    function buildExprTree(tokens) {
      console.log("lllllllllllllllll len 97")
  ...
  function remove_cpp_comments_in_shaders(code) {
    console.log("lllllllllllllllll len 98")
    var i = 0,
      out = "",
      ch,
      next,
  ...
  function _glShaderSource(shader, count, string, length) {
    console.log("lllllllllllllllll len 99")
  ...
  function _glUnmapBuffer(target) {
    console.log("lllllllllllllllll len 100")
    if (!emscriptenWebGLValidateMapBufferTarget(target)) {
      GL.recordError(1280);
  ...
  function _strftime(s, maxsize, format, tm) {
    console.log("lllllllllllllllll len 101")
    ...
    function leadingSomething(value, digits, character) {
      console.log("lllllllllllllllll len 102")
    ...
    function getWeekBasedYear(date) {
      console.log("lllllllllllllllll len 103")
  ...
  function intArrayFromString(stringy, dontAddNull, length) {
    console.log("lllllllllllllllll len 104")
  ...
  var asmLibraryArg = {
    ...
    Jg: _QGAccessFile,
    eh: _QGCreateBannerAd,
    _g: _QGCreateBoxBannerAd,
    Zg: _QGCreateBoxPortalAd,
    ah: _QGCreateCustomAd,
    dh: _QGCreateInterstitialAd,
    bh: _QGCreateNativeAd,
    ch: _QGCreateRewardedVideoAd,
    Tg: _QGDestroyAd,
    Gg: _QGGetFileBuffer,
    cc: _QGGetUserInfo,
    bc: _QGHasShortcutInstalled,
    Vg: _QGHideAd,
    fh: _QGInstallShortcut,
    $g: _QGIsShow,
    Ug: _QGLoadAd,
    dc: _QGLogin,
    Kg: _QGPay,
    ...
    Yg: _QGReportAdShow,
    Wg: _QGShowAd,
    Ha: _QGStorageDeleteAllSync,
    Mg: _QGStorageDeleteKeySync,
    Ng: _QGStorageGetFloatSync,
    Rg: _QGStorageGetIntSync,
    Pg: _QGStorageGetStringSync,
    Lg: _QGStorageHasKeySync,
    Og: _QGStorageSetFloatSync,
    Sg: _QGStorageSetIntSync,
    Qg: _QGStorageSetStringSync,
    Hg: _QGWriteFile,
  ...
  var dynCall_iiij = (Module["dynCall_iiij"] = function () {
    return (dynCall_iiij = Module["dynCall_iiij"] = Module["asm"]["Uh"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_i = (Module["dynCall_i"] = function () {
    return (dynCall_i = Module["dynCall_i"] = Module["asm"]["Wh"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jiii = (Module["dynCall_jiii"] = function () {
    return (dynCall_jiii = Module["dynCall_jiii"] = Module["asm"]["bi"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ijji = (Module["dynCall_ijji"] = function () {
    return (dynCall_ijji = Module["dynCall_ijji"] = Module["asm"]["li"]).apply(
      null,
      arguments
    );
  });
  var dynCall_jjji = (Module["dynCall_jjji"] = function () {
    return (dynCall_jjji = Module["dynCall_jjji"] = Module["asm"]["mi"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vji = (Module["dynCall_vji"] = function () {
    return (dynCall_vji = Module["dynCall_vji"] = Module["asm"]["qi"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ji = (Module["dynCall_ji"] = function () {
    return (dynCall_ji = Module["dynCall_ji"] = Module["asm"]["Bi"]).apply(
      null,
      arguments
    );
  });
  var dynCall_jijj = (Module["dynCall_jijj"] = function () {
    return (dynCall_jijj = Module["dynCall_jijj"] = Module["asm"]["Ci"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jji = (Module["dynCall_jji"] = function () {
    return (dynCall_jji = Module["dynCall_jji"] = Module["asm"]["Li"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_fii = (Module["dynCall_fii"] = function () {
    return (dynCall_fii = Module["dynCall_fii"] = Module["asm"]["Xi"]).apply(
      null,
      arguments
    );
  });
  var dynCall_viijjjji = (Module["dynCall_viijjjji"] = function () {
    return (dynCall_viijjjji = Module["dynCall_viijjjji"] =
      Module["asm"]["Yi"]).apply(null, arguments);
  });
  ...
  var dynCall_ffi = (Module["dynCall_ffi"] = function () {
    return (dynCall_ffi = Module["dynCall_ffi"] = Module["asm"]["gj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vfii = (Module["dynCall_vfii"] = function () {
    return (dynCall_vfii = Module["dynCall_vfii"] = Module["asm"]["ij"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iifi = (Module["dynCall_iifi"] = function () {
    return (dynCall_iifi = Module["dynCall_iifi"] = Module["asm"]["vj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ifi = (Module["dynCall_ifi"] = function () {
    return (dynCall_ifi = Module["dynCall_ifi"] = Module["asm"]["Cj"]).apply(
      null,
      arguments
    );
  });
  var dynCall_idi = (Module["dynCall_idi"] = function () {
    return (dynCall_idi = Module["dynCall_idi"] = Module["asm"]["Dj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jjii = (Module["dynCall_jjii"] = function () {
    return (dynCall_jjii = Module["dynCall_jjii"] = Module["asm"]["Gj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ijii = (Module["dynCall_ijii"] = function () {
    return (dynCall_ijii = Module["dynCall_ijii"] = Module["asm"]["Tj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jfi = (Module["dynCall_jfi"] = function () {
    return (dynCall_jfi = Module["dynCall_jfi"] = Module["asm"]["_j"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fji = (Module["dynCall_fji"] = function () {
    return (dynCall_fji = Module["dynCall_fji"] = Module["asm"]["$j"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fdi = (Module["dynCall_fdi"] = function () {
    return (dynCall_fdi = Module["dynCall_fdi"] = Module["asm"]["ak"]).apply(
      null,
      arguments
    );
  });
  var dynCall_dji = (Module["dynCall_dji"] = function () {
    return (dynCall_dji = Module["dynCall_dji"] = Module["asm"]["bk"]).apply(
      null,
      arguments
    );
  });
  var dynCall_dfi = (Module["dynCall_dfi"] = function () {
    return (dynCall_dfi = Module["dynCall_dfi"] = Module["asm"]["ck"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vidi = (Module["dynCall_vidi"] = function () {
    return (dynCall_vidi = Module["dynCall_vidi"] = Module["asm"]["dk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jidi = (Module["dynCall_jidi"] = function () {
    return (dynCall_jidi = Module["dynCall_jidi"] = Module["asm"]["gk"]).apply(
      null,
      arguments
    );
  });
  var dynCall_iidi = (Module["dynCall_iidi"] = function () {
    return (dynCall_iidi = Module["dynCall_iidi"] = Module["asm"]["hk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ddi = (Module["dynCall_ddi"] = function () {
    return (dynCall_ddi = Module["dynCall_ddi"] = Module["asm"]["rk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jdii = (Module["dynCall_jdii"] = function () {
    return (dynCall_jdii = Module["dynCall_jdii"] = Module["asm"]["Bk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vdii = (Module["dynCall_vdii"] = function () {
    return (dynCall_vdii = Module["dynCall_vdii"] = Module["asm"]["Fk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_didi = (Module["dynCall_didi"] = function () {
    return (dynCall_didi = Module["dynCall_didi"] = Module["asm"]["Kk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_fi = (Module["dynCall_fi"] = function () {
    return (dynCall_fi = Module["dynCall_fi"] = Module["asm"]["Uk"]).apply(
      null,
      arguments
    );
  });
  var dynCall_di = (Module["dynCall_di"] = function () {
    return (dynCall_di = Module["dynCall_di"] = Module["asm"]["Vk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_fff = (Module["dynCall_fff"] = function () {
    return (dynCall_fff = Module["dynCall_fff"] = Module["asm"]["dl"]).apply(
      null,
      arguments
    );
  });
  var dynCall_ijj = (Module["dynCall_ijj"] = function () {
    return (dynCall_ijj = Module["dynCall_ijj"] = Module["asm"]["el"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vjji = (Module["dynCall_vjji"] = function () {
    return (dynCall_vjji = Module["dynCall_vjji"] = Module["asm"]["fl"]).apply(
      null,
      arguments
    );
  });
  var dynCall_ij = (Module["dynCall_ij"] = function () {
    return (dynCall_ij = Module["dynCall_ij"] = Module["asm"]["gl"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vif = (Module["dynCall_vif"] = function () {
    return (dynCall_vif = Module["dynCall_vif"] = Module["asm"]["il"]).apply(
      null,
      arguments
    );
  });
  var dynCall_viif = (Module["dynCall_viif"] = function () {
    return (dynCall_viif = Module["dynCall_viif"] = Module["asm"]["jl"]).apply(
      null,
      arguments
    );
  });
  var dynCall_iiif = (Module["dynCall_iiif"] = function () {
    return (dynCall_iiif = Module["dynCall_iiif"] = Module["asm"]["kl"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_fiff = (Module["dynCall_fiff"] = function () {
    return (dynCall_fiff = Module["dynCall_fiff"] = Module["asm"]["rl"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_viff = (Module["dynCall_viff"] = function () {
    return (dynCall_viff = Module["dynCall_viff"] = Module["asm"]["Gl"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iif = (Module["dynCall_iif"] = function () {
    return (dynCall_iif = Module["dynCall_iif"] = Module["asm"]["Ql"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vij = (Module["dynCall_vij"] = function () {
    return (dynCall_vij = Module["dynCall_vij"] = Module["asm"]["am"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vff = (Module["dynCall_vff"] = function () {
    return (dynCall_vff = Module["dynCall_vff"] = Module["asm"]["em"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vfff = (Module["dynCall_vfff"] = function () {
    return (dynCall_vfff = Module["dynCall_vfff"] = Module["asm"]["fm"]).apply(
      null,
      arguments
    );
  });
  var dynCall_ff = (Module["dynCall_ff"] = function () {
    return (dynCall_ff = Module["dynCall_ff"] = Module["asm"]["gm"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vfi = (Module["dynCall_vfi"] = function () {
    return (dynCall_vfi = Module["dynCall_vfi"] = Module["asm"]["hm"]).apply(
      null,
      arguments
    );
  });
  ...
  function callMain(args) {
    console.log("+++++++++++++ callMain 1")
    var entryFunction = Module["_main"];
    console.log("+++++++++++++ callMain 2")
    args = args || [];
    console.log("+++++++++++++ callMain 3")
    var argc = args.length + 1;
    var argv = stackAlloc((argc + 1) * 4);
    console.log("+++++++++++++ callMain 4")
    HEAP32[argv >> 2] = allocateUTF8OnStack(thisProgram);
    console.log("+++++++++++++ callMain 5")
    for (var i = 1; i < argc; i++) {
      console.log("+++++++++++++ callMain 6")
      HEAP32[(argv >> 2) + i] = allocateUTF8OnStack(args[i - 1]);
      console.log("+++++++++++++ callMain 7")
    }
    HEAP32[(argv >> 2) + argc] = 0; 
    console.log("+++++++++++++ callMain 8")
    // try {
      
    // } catch (e) {
    //   if (e instanceof ExitStatus) {
    //     console.log("+++++++++++++ callMain 11")
    //     return;
    //   } else if (e == "unwind") {
    //     console.log("+++++++++++++ callMain 12")
    //     return;
    //   } else {
    //     console.log("+++++++++++++ callMain 13")
    //     var toLog = e;
    //     if (e && typeof e === "object" && e.stack) {
    //       toLog = [e, e.stack];
    //       console.log("+++++++++++++ callMain 14")
    //     }
    //     err("exception thrown: " + toLog);
    //     console.log("+++++++++++++ callMain 15", toLog)
    //     quit_(1, e);
    //   }
    // } finally {
    //   calledMain = true;
    ...
    console.log("+++++++++++++ callMain 9", argc, argv)
    var ret = entryFunction(argc, argv);
    console.log("+++++++++++++ callMain 10")
    exit(ret, true);
    calledMain = true;
  }
  function run(args) {
    ...
    function doRun() {
      console.log("+++++++++++++ framework 7")
      if (calledRun) return;
      console.log("+++++++++++++ framework 8")
      calledRun = true;
      Module["calledRun"] = true;
      if (ABORT) return;
      initRuntime();
      console.log("+++++++++++++ framework 9")
      preMain();
      console.log("+++++++++++++ framework 10")
      
      if (Module["onRuntimeInitialized"]) {
        console.log("+++++++++++++ framework 11")
        Module["onRuntimeInitialized"]();
        console.log("+++++++++++++ framework 12")
      }

      if (shouldRunNow) {
        console.log("+++++++++++++ framework 13")
        callMain(args)
        console.log("+++++++++++++ framework 14")
      };

      console.log("+++++++++++++ framework 15")
      postRun();
      console.log("+++++++++++++ framework 16")
    }
    if (Module["setStatus"]) {
      ...
      setTimeout(function () {
        ...
        doRun();
        console.log("+++++++++++++ framework 4")
      }, 1);
    } else {
      console.log("+++++++++++++ framework 5")
      doRun();
      console.log("+++++++++++++ framework 6")
    }
  }
  Module["run"] = run;
